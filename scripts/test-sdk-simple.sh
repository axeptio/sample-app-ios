...
echo -e "${YELLOW}1. NSDate Serialization Fix (MSK-84):${NC}"
echo -e "   • Tap 'Consent Debug Info' or similar button"
echo -e "   • App should NOT crash with __NSTaggedDate error"
echo -e "   • Debug data should display properly with ISO8601 date strings"
echo -e ""
echo -e "${YELLOW}2. Vendor Consent APIs (MSK-83):${NC}"
echo -e "   • Test new vendor consent methods are available"
echo -e "   • Check TCF v2.0 compliance features"
echo -e ""
echo -e "${YELLOW}3. SDK Version Check:${NC}"
