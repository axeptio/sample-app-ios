...
#ifndef AXEPTIO_SWIFT_H
#define AXEPTIO_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="Axeptio",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
SWIFT_CLASS("_TtC7Axeptio20AxeptioEventListener")
...
SWIFT_CLASS("_TtC7Axeptio10AxeptioSDK")
@interface AxeptioSDK : NSObject
SWIFT_CLASS_PROPERTY(@property (nonatomic, class, readonly, strong) AxeptioSDK * _Nonnull shared;)
+ (AxeptioSDK * _Nonnull)shared SWIFT_WARN_UNUSED_RESULT;
...
SWIFT_CLASS("_TtC7Axeptio15GoogleConsentV2")
